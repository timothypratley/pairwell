...
;(chsk-send! [:pairwell/hi "hello world"])

#_(go-loop [[event data] (<! ch-chsk)]
  (match event
         :pairwell/hi (.log js/console "FOO" data)
         :else nil))
